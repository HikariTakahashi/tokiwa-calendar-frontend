<template>
  <div class="container p-2 max-w-full max-h-full">
    <div
    ...
    <div class="grid grid-cols-7 gap-2">
      <div
        ...
        :key="date.date"
        class="flex flex-col items-center border rounded transition-transform duration-200 hover:-translate-y-1 shadow-md min-h-[100px]"
